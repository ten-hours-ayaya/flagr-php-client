...
class EvaluationApi
{
     ...
     *
     * @param  \Ayaya\FlagrClient\Model\EvalContext $body evalution context (required)
     *
     ...
     * @throws \Ayaya\FlagrClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ayaya\FlagrClient\Model\EvalResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function postEvaluationWithHttpInfo($body)
    {
        $returnType = '\Ayaya\FlagrClient\Model\EvalResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ayaya\FlagrClient\Model\EvalResult',
     ...
     *
     * @param  \Ayaya\FlagrClient\Model\EvaluationBatchRequest $body evalution batch request (required)
     *
     * @throws \Ayaya\FlagrClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ayaya\FlagrClient\Model\EvaluationBatchResponse
     */
     ...
     * @throws \Ayaya\FlagrClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ayaya\FlagrClient\Model\EvaluationBatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postEvaluationBatchWithHttpInfo($body)
    {
        $returnType = '\Ayaya\FlagrClient\Model\EvaluationBatchResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ayaya\FlagrClient\Model\EvaluationBatchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
