...
class HealthApi
{
     ...
     * @return \Ayaya\FlagrClient\Model\Health
     */
     ...
     * @throws \Ayaya\FlagrClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ayaya\FlagrClient\Model\Health, HTTP status code, HTTP response headers (array of strings)
     */
    public function getHealthWithHttpInfo()
    {
        $returnType = '\Ayaya\FlagrClient\Model\Health';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ayaya\FlagrClient\Model\Health',
